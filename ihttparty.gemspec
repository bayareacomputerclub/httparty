...
Gem::Specification.new do |s|
  ...
  s.authors = ["John Nunemaker", "Sandro Turriate", "Luke Bayes"]
  s.date = %q{2010-07-09}
  s.default_executable = %q{httparty}
  s.description = %q{Just like HTTParty, but uses instances in place of classes.}
  ...
  s.summary = %q{Just like HTTParty, but uses instances in place of classes.}
  s.test_files = [
    "spec/httparty/cookie_hash_spec.rb",
     "spec/httparty/parser_spec.rb",
     "spec/httparty/request_spec.rb",
