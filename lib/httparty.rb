...
module HTTParty
  ...
  attr_reader :default_cookies

  extend AllowedFormatsDeprecation

  def initialize *args
    @default_options = {}
    @default_cookies = CookieHash.new
  end
  ...
  def self.get(*args)
    Basement.new().get(*args)
  end

  def self.post(*args)
    Basement.new().post(*args)
  end

  def self.put(*args)
    Basement.new().put(*args)
  end

  def self.delete(*args)
    Basement.new().delete(*args)
  end

  def self.head(*args)
    Basement.new().head(*args)
  end

  def self.options(*args)
    Basement.new().options(*args)
  end
