require 'rake'
require File.expand_path('../lib/ihttparty', __FILE__)

begin
  require 'jeweler'
  Jeweler::Tasks.new do |gem|
    gem.name        = "ihttparty"
    gem.summary     = %Q{Just like HTTParty, but uses instances in place of classes.}
    gem.description = %Q{Just like HTTParty, but uses instances in place of classes.}
    gem.email       = "nunemaker@gmail.com"
    gem.homepage    = "http://httparty.rubyforge.org"
    gem.authors     = ["John Nunemaker", "Sandro Turriate", "Luke Bayes"]
